...
<body class="page-wrapper">
    ...
    <div class="about-bg centered">
        <div class="container">
            <div class="text">Personal advisory services</div>
        </div>
    </div>
    <!-- end page title -->
    <!-- bread-crumb -->
    <div class="bread-crumb">
        <div class="container">
            <div class="text">
                <a href="index-2.html">Home</a><i class="fa fa-angle-right"></i>Personal advisory services
            </div>
        </div>
    </div>
    <!-- bread crumb end -->
                ...
                <div class="col-md-8 col-sm-12 col-xs-12 service-colmun">
                    <div class="sidebar-details">
                        <div class="content-style-three">
                            <h3 style="font-size:30px">Personal advisory services</h3>
                            <div class="content-style-two">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12 service-colmun">
                                        <div class="content-side">
                                            <ul class="list">
                                                <li><p>Personal financial planning</p></li>
                                                <li><p>Insurance and pension planning</p></li>
                                                <li><p>Formation of trusts</p></li>
                                                <li><p>Acting as arbitrator</p></li>
                                                <li><p>Wills</p></li>
                                            </ul>
                                        </div>
                                    </div>
